...
from tictactoe_ai.observation import (
    ...
    get_beforestate_observation_vec,
    get_afterstate_observation_vec,
)
...
def train_step(static_state: StaticState, step_state: StepState) -> StepState:
    ...
    # pick an action
    before_obs = get_beforestate_observation_vec(env_state)
    ...
    after_obs = get_afterstate_observation_vec(env_state)
    ...
    # train
    opponent_reward = get_reward(env_state)
