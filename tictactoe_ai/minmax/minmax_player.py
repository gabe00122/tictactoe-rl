...
def get_action(optimal_play: Int8[Array, "3 3 3 3 3 3 3 3 3 9"], game: GameState, rng_key: PRNGKeyArray):
...
class MinmaxAgent(Agent[MinmaxState]):
    ...
    def act(self, agent_state: MinmaxState, game_states: VectorizedGameState, rng_keys: Key[Array, "vec"]) -> Int8[Array, "vec"]:
        return jax.vmap(get_action, in_axes=(None, 0, 0))(agent_state.state_actions, game_states, rng_keys) # type: ignore

    def learn(self, params: MinmaxState, game_states: VectorizedGameState, actions: Array, rewards: Array, next_obs: VectorizedGameState) -> tuple[MinmaxState, Metrics]:
